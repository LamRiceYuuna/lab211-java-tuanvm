...
public class StudentManager {
    ...
    public void createStudent(ArrayList<Student> students) {
        ...
        while (true) {
            ...
            if (students.size() >= 10) {
                ...
                if (!GetInput.getChoice("Do you want to continue (Y/N)?: ", "Y", "N")) {
                    return;
                }
            }
        }
    ...
    private Student inputInformationOfStudent(ArrayList<Student> students) {
        String id = GetInput.getString("Enter student id: ");
        ...
        if (name != null) {
            ...
            name = GetInput.getName("Enter student name: ");
        }
        System.out.print("Enter semester: ");
        int semester = GetInput.getChoiceInt(1, Integer.MAX_VALUE);
        ...
        if (GetInput.checkInformationStudentExist(students, student)) {
    ...
    private String choiceCourse() {
        ...
        int choice = GetInput.getChoiceInt(1, 3);
        // Choice course
        switch (choice) {
            case 1:
                return "Java";
    ...
    public void findAndSort(ArrayList<Student> students) {
        ...
        String name = GetInput.getName("Enter name: ");
    ...
    // Sort list information of the students by name in alphabetical 00order
    ...
    public void updateOrDelete(ArrayList<Student> students) {
        ...
        String id = GetInput.getString("Enter Id: ");
        ...
        if (!listStudentFindByID.isEmpty()) {
            ...
            if (GetInput.getChoice("Do you want to update (U) or delete (D) student?: ", "U", "D")) {
                // Update processing
    ...
    private void updateProcess(ArrayList<Student> students, ArrayList<Student> listStudentFindByID, String id) {
        ...
        int choiceNumber = GetInput.getChoiceInt(1, listStudentFindByID.size());
    ...
    private Student inputInfomationStudent(ArrayList<Student> students, ArrayList<Student> listStudentFindByID, int choice) {
        String id = GetInput.getString("Enter id student: ");
        String name = name = GetInput.getName("Enter name student: ");
        System.out.print("Enter semester: ");
        int semester = GetInput.getChoiceInt(1, Integer.MAX_VALUE);
        System.out.println("Enter course name: ");
        String courseName = choiceCourse();
        ...
        if (GetInput.checkInformationStudentExist(students, newStudent)) {
